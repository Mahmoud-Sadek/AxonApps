...
//    lateinit var txtJoinUsProviderName: EditText
    ...
    override fun onCreateView(layoutInflater: LayoutInflater, viewGroup: ViewGroup?, bundle: Bundle?): View {
        var view = layoutInflater.inflate(R.layout.fragment_signup, viewGroup, false)
        ...
        btnSubmitRequest.setOnClickListener(View.OnClickListener {
            if (validate())
                startActivity(Intent(accountActivity, MainActivity::class.java))
        })
        return view
    }
